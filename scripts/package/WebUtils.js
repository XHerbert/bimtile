...
WebUtils.prototype = Object.assign(WebUtils.prototype, {
     ...
     */
    viewer: null,
    bim_host: "http://10.0.197.82:8078/bim/",//数据库不同。导致报错
    wanda_host: "http://10.0.197.82:90/wanda/",
    ...
    getViewtoken: function (modelId, type) {
        let _fileUrl = this.bim_host + 'token/getFilePreviewToken?fileId=' + modelId;
        let _integrateUrl = this.bim_host + 'token/getIntegratePreviewToken?integrateId=' + modelId;
     ...
     * @param {String} mepId MEP Id
     */
    getInflunceArea: function (modelTyp, projectId, modelId, mepId) {
        let _url = this.bim_host + 'equipmentRefer/getInfluenceRoomByEquipment?modelTyp=' + modelTyp + '&modelId=' + modelId + '&projectId=' + projectId + '&id=' + mepId;
        return new Promise(function (resolve, reject) {
            let option = {
                url: _url,
                type: 'GET',
    ...
    getTerminalComponents: function (projectId, baseEquipment) {
        let _url = this.bim_host + 'equipmentRefer/getTerminalByEquipment?projectId=' + projectId + '&baseEquipment=' + baseEquipment;
        return new Promise(function (resolve, reject) {
            let option = {
                url: _url,
                type: 'GET',
     ...
     * 获取主设备MEP回路所有构件
     * @param {Number} projectId 项目
     * @param {String} mepId mepId
     */
    getNetworkComponents: function (projectId, mepId) {
        let _url = this.bim_host + 'equipmentRefer/getNetworkByEquipment?projectId=' + projectId + '&id=' + mepId;
        return new Promise(function (resolve, reject) {
            let option = {
                url: _url,
                type: 'GET',
    ...
    /**
     * 获取主设备所在空间
     * @param {Number} modelType 模型类型 1：单模型  2：集成模型
     * @param {Number} modelId 模型Id
     * @param {String} objectId 设备构件Id
     * @param {Number} mepId mep Id
     */
    getRoomByComponent: function (modelType, modelId, objectId, mepId) {
        let _url = this.bim_host + 'equipmentRefer/getRoomByComponent?modelTyp=' + modelType + '&modelId=' + modelId + '&mepId=' + mepId + '&objectId=' + objectId;
        return new Promise(function (resolve, reject) {
            let option = {
                url: _url,
                type: 'GET',
     ...
     */
    getValidateEquipment: function (modelId) {
        let behaviuorUrl = this.bim_host + "equipmentRefer/getValidateEquipment?modelId=" + modelId;
        return new Promise(function (resolve, reject) {
            let opt = {
                url: behaviuorUrl,
                type: 'GET',
    ...
    getRenderModelBehaviour: function (referKey) {
        let behaviuorUrl = this.wanda_host + "bimModelEffective/getModelEffectivePipeline?referKey=" + referKey + "&projectId=390";
        return new Promise(function (resolve, reject) {
            let opt = {
                url: behaviuorUrl,
                type: 'GET',
